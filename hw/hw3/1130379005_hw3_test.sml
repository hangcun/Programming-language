val tyc1 = typecheck_patterns ([],[TupleP[Wildcard, TupleP[Wildcard,Wildcard]], TupleP[Wildcard,Wildcard]]);
val tyc2 = typecheck_patterns ([],[TupleP[Wildcard,Wildcard], TupleP[Variable
"x",Variable "y"]]);
